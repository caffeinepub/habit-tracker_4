...
export class Backend implements backendInterface {
    ...
    async getDummyHabits(): Promise<Array<[string, string]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDummyHabits();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getHabit(arg0: bigint): Promise<HabitView> {
        if (this.processError) {
            try {
    ...
    async getHabitsByCheckIns(): Promise<Array<HabitView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getHabitsByCheckIns();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async hasHabits(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.hasHabits();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
